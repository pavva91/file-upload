...
// func (c *minio.Client) PutObjectMultipart(ctx context.Context, bucketName, objectName string, reader io.Reader, size int64,
// 	opts PutObjectOptions,
// ) (info UploadInfo, err error) {
// 	info, err = MinioClient.putObjectMultipartNoStream(ctx, bucketName, objectName, reader, opts)
// 	if err != nil {
...
// 			return storage.MinioClient.putObject(ctx, bucketName, objectName, reader, size, opts)
// 		}
// 	}
// 	return info, err
// }
//
// func (c *MinioClient) putObjectMultipartNoStream(ctx context.Context, bucketName, objectName string, reader io.Reader, opts PutObjectOptions) (info UploadInfo, err error) {
// 	// Input validation.
...
// func (c *MinioClient) initiateMultipartUpload(ctx context.Context, bucketName, objectName string, opts PutObjectOptions) (initiateMultipartUploadResult, error) {
// 	// Input validation.
// 	if err := s3utils.CheckValidBucketName(bucketName); err != nil {
...
// func (c *MinioClient) uploadPart(ctx context.Context, p uploadPartParams) (ObjectPart, error) {
// 	// Input validation.
...
// func (c *MinioClient) completeMultipartUpload(ctx context.Context, bucketName, objectName, uploadID string,
